  ...
  return (
    <Layout>
      ...
      <main className="relative w-11/12 max-w-md mx-auto mt-10 mb-32 space-y-4 md:max-w-xl lg:max-w-2xl md:mt-12">
        ...
        <p>
          Melody Chuang Coaching will retain your personal information only for
          ...
          enforce our policies. Our Privacy Policy was generated with the help
          of{' '}
          <StyleLink>
            <a href="https://www.gdprprivacynotice.com/">GDPR Privacy Notice</a>
          </StyleLink>{' '}
          and the{' '}
          <StyleLink>
