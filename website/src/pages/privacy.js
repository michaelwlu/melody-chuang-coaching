...
const PrivacyPolicy = () => {
  return (
    <Layout>
      ...
      <WidthWrapper>
        <main className="max-w-3xl mx-auto mt-12 space-y-4 font-sans text-sm">
          <h1 className="text-2xl italic font-semibold font-themeSerif">
            Privacy Policy for Melody Chuang Coaching
          </h1>
          <p>
            At Melody Chuang Coaching, accessible from www.melodychuang.com, one
            of our main priorities is the privacy of our visitors. This Privacy
            Policy document contains types of information that is collected and
            recorded by Melody Chuang Coaching and how we use it.
          </p>
          ...
          <h2 className="pt-3 text-xl italic font-semibold font-themeSerif">
            General Data Protection Regulation (GDPR)
          </h2>
          <p>We are a Data Controller of your information.</p>

          <p>
            Melody Chuang Coaching's legal basis for collecting and using the
          ...
          <ul className="list-disc list-inside">
            <li>Melody Chuang Coaching needs to perform a contract with you</li>
            <li>You have given Melody Chuang Coaching permission to do so</li>
            <li>
              Processing your personal information is in Melody Chuang
              Coaching's legitimate interests
            </li>
            <li>Melody Chuang Coaching needs to comply with the law</li>
          </ul>

          <p>
            Melody Chuang Coaching will retain your personal information only
            ...
            help of{' '}
            <StyledLink href="https://www.gdprprivacynotice.com/">
              GDPR Privacy Notice
            </StyledLink>{' '}
            and the{' '}
            <StyledLink href="https://www.gdprcontracts.com/gdpr-privacy-policy-generator/">
          ...
          <p>
            Melody Chuang Coaching follows a standard procedure of using log
          ...
          <p>
            Like any other website, Melody Chuang Coaching uses 'cookies'. These
          ...
          <p>
            ...
            <StyledLink href="http://www.whatarecookies.com/">
              "What Are Cookies"
            </StyledLink>
            .
          </p>
          ...
          <p>
            ...
            advertising partners of Melody Chuang Coaching.
          </p>

          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on Melody Chuang
            Coaching, which are sent directly to users' browser. They
          ...
          <p>
            Note that Melody Chuang Coaching has no access to or control over
          ...
          <p>
            Melody Chuang Coaching's Privacy Policy does not apply to other
          ...
          <p>
            Melody Chuang Coaching does not knowingly collect any Personal
          ...
          <p>
            ...
            that they shared and/or collect in Melody Chuang Coaching. This
