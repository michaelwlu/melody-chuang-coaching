...
const PrivacyPolicy = () => {
  return (
    <main className="relative w-11/12 max-w-md mx-auto mt-10 mb-32 space-y-4 md:max-w-xl lg:max-w-2xl md:mt-12">
      ...
      <p>
        At Melody Chuang Coaching, accessible from www.melodychuang.com, one of
        ...
        Melody Chuang Coaching and how we use it.
      </p>
      ...
      <h2 className="pt-3 text-xl italic font-semibold lg:text-2xl font-themeSerif">
      ...
      <ul className="list-disc list-inside">
        ...
        <li>
          Processing your personal information is in Melody Chuang Coaching's
      ...
      <p>
        Melody Chuang Coaching will retain your personal information only for as
        ...
        Our Privacy Policy was generated with the help of{' '}
        <a href="https://www.gdprprivacynotice.com/" className="text-blue-600">
          GDPR Privacy Notice
        </a>{' '}
        and the{' '}
        <a
          href="https://www.gdprcontracts.com/gdpr-privacy-policy-generator/"
      ...
      <p>
        Melody Chuang Coaching follows a standard procedure of using log files.
      ...
      <p>
        ...
        <a href="http://www.whatarecookies.com/" className="text-blue-600">
          "What Are Cookies"
        </a>
        .
      </p>
      ...
      <p>
        ...
        advertisements and links that appear on Melody Chuang Coaching, which
      ...
      <p>
        Note that Melody Chuang Coaching has no access to or control over these
      ...
      <p>
        ...
        shared and/or collect in Melody Chuang Coaching. This policy is not
